...
model.add(Conv1D(100, 10, activation='relu', input_shape=(SEGMENT_LENGTH, 1), kernel_initializer='VarianceScaling'))
model.add(Conv1D(100, 10, activation='relu', kernel_initializer='VarianceScaling'))
model.add(MaxPooling1D(2))
model.add(Conv1D(160, 10, activation='relu', kernel_initializer='VarianceScaling'))
model.add(Conv1D(160, 10, activation='relu', kernel_initializer='VarianceScaling'))
