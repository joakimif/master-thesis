...
However, looking at the graphs for loss and accuracy \ref{figure:control_condition_10e} for how the training went epoch by epoch for each of the experiment's datasets, 
