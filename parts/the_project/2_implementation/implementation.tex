...
The following model is used to achieve our first goal; classifying whether a participant belongs to the \textbf{control} or \textbf{condition} group.
...
but to keep things simple, we will use an optimizer called \textbf{Adam} for training all of our models. Using a different optimizer can make the 
trained model perform differently. 
