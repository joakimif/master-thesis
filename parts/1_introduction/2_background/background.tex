\section{Depression}
In this thesis, participants in the condition group are either diagnosed with bipolar disorder or unipolar depression. The difference between the conditions is that bipolar disorder is more than just depression; they also experience what is called \textit{mania}. This section is an introduction to bipolar disorder and a rating for depression: MADRS. 
...
We split related work in two: mental health and convolutional neural networks. In this section, we mention several research papers that are related to these two topics. 
