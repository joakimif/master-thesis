...
\begin{figure}
      ...
      \caption{Regression Training Loss by Epoch}
      \label{figure:regression_training_loss}
\end{figure}

\begin{figure}
      \includegraphics[height=8cm]{img/regression/confusion_kerasregressor_gender.png}
      \caption{Confusion Matrix for Regression using Gender}
      \label{figure:regression_confusion_gender}
\end{figure}

\begin{figure}
      \includegraphics[height=8cm]{img/regression/confusion_kerasregressor_age.png}
      \caption{Confusion Matrix for Regression using Age}
      \label{figure:regression_confusion_age}
\end{figure}

\begin{figure}
      \includegraphics[height=8cm]{img/regression/confusion_kerasregressor_days.png}
      \caption{Confusion Matrix for Regression using Days}
      \label{figure:regression_confusion_days}
\end{figure}

\begin{figure}
      \includegraphics[height=8cm]{img/regression/confusion_kerasregressor_madrs1.png}
      \caption{Confusion Matrix for Regression using MADRS1}
      \label{figure:regression_confusion_madrs1}
\end{figure}

\begin{figure}
      \includegraphics[height=8cm]{img/regression/confusion_kerasregressor_madrs2.png}
      \caption{Confusion Matrix for Regression using MADRS2}
      \label{figure:regression_confusion_madrs2}
\end{figure}
