...
relationships between variables[CITE]. One experiment that might be interesting is to do linear regression on some of the columns in the demographics dataset 
